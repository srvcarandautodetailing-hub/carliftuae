...
export const metadata: Metadata = {
  title: "Car Lift Sharjah via Sheikh Zayed Road – DIFC & Business Bay | +971 54 330 8261",
  description:
    "Daily car lift Sharjah via Sheikh Zayed Road to Business Bay, DIFC & JLT from AED 130 sharing / AED 200 private. GPS-tracked, Salik included, 4.9★ rated. WhatsApp +971 54 330 8261.",
  keywords:
  ...
  openGraph: {
    title: "Car Lift Sharjah via Sheikh Zayed Road – DIFC & Business Bay | +971 54 330 8261",
    description:
      "Covers Business Bay, DIFC, JLT & Dubai Marina. AED 130 sharing–450/month. Salik included, GPS-tracked, 4.9★ rated. WhatsApp +971 54 330 8261.",
    // OG image generated by src/app/bus-car-lift-service-from-sharjah-sheikh-zayed/opengraph-image.tsx
  },
};
...
const PAGE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Monthly car lift from Sharjah via SZR costs AED 130 sharing–450/month depending on your Sharjah pickup area and Dubai destination. Business Bay/DIFC from Al Nahda is AED 130 sharing–320/month. JLT/Marina destinations are AED 130 sharing–450/month due to the longer route. All prices include Salik tolls.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We offer car lift from Sharjah to JLT (Jumeirah Lakes Towers) and Dubai Marina via Sheikh Zayed Road. Monthly price from Sharjah Al Nahda to JLT is approximately AED 130 sharing–420/month. WhatsApp us for an exact quote based on your pickup area.",
  },
  {
...
export default function BusCarLiftSharjahSheikhZayedPage() {
  ...
  const schemas = [
    ...
    serviceSchema({
      ...
      description:
        "Daily shared car lift from Sharjah via Sheikh Zayed Road to Business Bay, DIFC, JLT, Dubai Marina, and Media City. Monthly packages from AED 130 sharing / AED 200 private.",
    ...
    primaryImageOfPageSchema({
      ...
      pageUrl: "/bus-car-lift-service-from-sharjah-sheikh-zayed",
      caption: "Car lift UAE drop-off on Sheikh Zayed Road Dubai – daily commuters arriving at DIFC and Business Bay offices",
    }),
  ];
      ...
      <section aria-labelledby="pricing-heading" className="py-14 sm:py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
            {[
              { destination: "Business Bay / DIFC", price: "AED 130 sharing–350", note: "Most popular route", popular: true },
              { destination: "JLT / Al Qouz", price: "AED 130 sharing–420", note: "Via SZR south", popular: false },
              { destination: "Dubai Marina / Media City", price: "AED 130 sharing–450", note: "Longer route", popular: false },
