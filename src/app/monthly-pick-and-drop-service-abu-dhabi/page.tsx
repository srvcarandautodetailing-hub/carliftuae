        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            <div className="flex-1">
              ...
              <p className="speakable-desc text-emerald-100 text-base sm:text-lg leading-relaxed mb-3 max-w-xl">Monthly door-to-door pick and drop from Abu Dhabi to Dubai and Sharjah. Reserved daily seat, fixed monthly rate, same driver every day. Mussafah, Khalifa City, MBZ, Al Shamkha, Al Raha covered.</p>
