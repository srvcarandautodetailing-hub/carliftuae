...
export const metadata: Metadata = {
  ...
  description:
    "Browse all Car Lift UAE routes. Sharjah to Business Bay from AED 130 sharing / AED 200 private, Ajman from AED 130 sharing / AED 200 private, Dubai internal routes from AED 100 sharing/month. 50+ daily routes, morning & evening service.",
  alternates: { canonical: "https://www.carliftuae.com/routes" },
  openGraph: {
    title: "Car Lift Routes UAE – Sharjah, Dubai, Ajman to Business Bay",
    description:
      "Find your car lift route. 50+ daily routes across UAE. Sharjah, Ajman, Dubai. All areas covered. Book monthly from AED 100 sharing.",
    // OG image generated by src/app/routes/opengraph-image.tsx
  },
};
...
export default function RoutesPage() {
  ...
  return (
    <>
      ...
      >
        <Image
          src="/images/routes/carlift-sheikh-zayed-road-dropoff.webp"
          alt="Car lift UAE drop-off on Sheikh Zayed Road Dubai – daily commuters arriving at glass tower offices"
          fill
          priority
          quality={78}
          sizes="100vw"
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-2 mb-6 list-none" role="list">
                  {[
                    ...
                    `Per-Trip Price: AED 130 sharing/trip (Sharjah ↔ Abu Dhabi)`,
