...
export const metadata: Metadata = {
  title: "Car Lift from Sharjah to Business Bay – AED 130 Sharing / AED 200 Private | +971 54 330 8261",
  description:
    "Car lift from Sharjah to Business Bay from AED 130 sharing / AED 200 private. Salik included, GPS-tracked, 4.9★ rated by 247+ riders. Ladies option available. WhatsApp +971 54 330 8261 – confirm your seat in 60 seconds.",
  keywords:
  ...
  openGraph: {
    title: "Car Lift from Sharjah to Business Bay – AED 130 Sharing / AED 200 Private | +971 54 330 8261",
    description:
      "AED 130 sharing / AED 200 private from Al Nahda. Salik included, GPS-tracked, 4.9★ rated. Ladies option. 500+ daily riders. WhatsApp +971 54 330 8261 – book in 60 seconds.",
...
const PAGE_FAQS = [
  {
    ...
    answer:
      "Car lift from Sharjah to Business Bay costs AED 130 sharing–420/month depending on your pickup area. Al Nahda (Sharjah) is AED 130 sharing / AED 200 private. Muweilah is AED 130 sharing / AED 200 private. University City is AED 130 sharing / AED 200 private. Daily trips cost AED 100 sharing–35 per one-way. All prices include Salik tolls — no hidden charges.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Daily car lift from Sharjah to Business Bay is available at AED 100 sharing–35 per one-way trip. Book via WhatsApp by 9:00 PM the night before. No monthly contract, no lock-in. If you travel regularly, the monthly package (from AED 130 sharing) is significantly cheaper.",
  },
  {
...
const PRICING_TABLE = [
  { area: "Al Nahda (Sharjah)", monthly: "AED 130 sharing", daily: "AED 100 sharing", note: "Closest zone" },
  { area: "Al Taawun / Al Khan", monthly: "AED 200", daily: "AED 26", note: "" },
  { area: "Al Majaz / Rolla", monthly: "AED 130 sharing", daily: "AED 28", note: "" },
  { area: "Muweilah", monthly: "AED 130 sharing", daily: "AED 30", note: "" },
  { area: "University City / Al Zahia", monthly: "AED 130 sharing", daily: "AED 33", note: "Farther zone" },
];
...
const ROUTE_FACTS = [
  ...
  { label: "Monthly (from)", value: "AED 130 sharing/person" },
  { label: "Daily Rate", value: "AED 100 sharing–35/trip" },
...
export default function CarLiftFromSharjahToBusinessBayPage() {
  ...
  const schemas = [
    ...
    serviceSchema({
      ...
      description:
        "Daily shared car lift from Sharjah to Business Bay, Dubai. Monthly packages from AED 130 sharing / AED 200 private. Salik included, GPS-tracked, ladies option available.",
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 bg-emerald-500/20 border border-emerald-400/30 rounded-full px-4 py-1.5 text-sm text-emerald-300 font-semibold mb-5">
                ...
                Sharjah &rarr; Business Bay &nbsp;·&nbsp; From AED 130 sharing / AED 200 private
              </div>
              ...
              <p className="speakable-desc text-slate-300 text-base sm:text-lg leading-relaxed mb-6 max-w-xl">
                ...
                Salik included, GPS-tracked, verified drivers. Monthly seats from AED 130 sharing/person.
              </p>
              ...
              <div className="bg-white/10 border border-white/20 rounded-2xl p-5 mb-6">
                ...
                <p className="text-white text-sm leading-relaxed">
                  Car lift from Sharjah to Business Bay costs <strong>AED 130 sharing–420/month</strong> depending on your pickup area (Al Nahda is AED 130 sharing, Muweilah is AED 130 sharing).
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { title: "Car Lift (Al Nahda)", amount: "AED 130 sharing / AED 200 private", sub: "Morning + evening · Salik included", color: "bg-emerald-50 border-emerald-200", textColor: "text-emerald-600" },
