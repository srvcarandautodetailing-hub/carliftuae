...
export const alt = "Car Lift from Sharjah to Business Bay – AED 300/month, GPS Tracked";
...
export default function Image() {
  return new ImageResponse(
    buildOgImageJsx({
      ...
      subtitle: "Daily shared car lift from Sharjah to Business Bay Dubai. AED 300/month. Salik included. 60-sec booking.",
      accentColor: "#059669",
      stats: [
