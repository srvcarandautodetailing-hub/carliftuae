...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Quick Car Lift Service UAE – Route Fares & Airport Transfer Prices",
    description:
      "Fixed car lift fares per trip. Dubai ↔ Abu Dhabi from AED 100 sharing. Airport transfers available on all routes. Call or WhatsApp to book.",
    ...
    <>
      <SchemaScript
        schema={serviceSchema({
          name: "Quick Car Lift Service UAE – Inter-Emirate Car Lift & Airport Transfer",
          description:
      ...
      <section aria-label="Book now CTA" className="py-14 bg-blue-600">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8 leading-relaxed">
            Contact Quick Car Lift Service UAE by phone or WhatsApp to confirm availability
