...
const emirateHeroImage: Record<Emirate, { src: string; alt: string }> = {
  sharjah: {
    ...
    alt: "Morning car lift pickup in Sharjah – daily commuters ready for Business Bay Dubai",
  },
  dubai: {
    src: "/images/locations/business-bay/business-bay-car-lift-professionals.webp",
    alt: "Business Bay Dubai car lift drop-off – professionals arriving at work",
  },
  ajman: {
    src: "/images/locations/sharjah/sharjah-car-lift-morning-pickup.webp",
    alt: "Daily car lift pickup service in Ajman – shared rides to Dubai",
  },
};
  ...
  return (
    <>
      ...
      >
        {/* Location hero image */}
        <Image
          src={emirateHeroImage[location.emirate].src}
          alt={emirateHeroImage[location.emirate].alt}
          fill
          priority
          quality={78}
          sizes="100vw"
