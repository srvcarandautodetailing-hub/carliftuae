...
export const metadata: Metadata = {
  title: "MJ Car Lift Service – Car Lift & Airport Transfer UAE",
  description:
    "MJ Car Lift Service covers Dubai ↔ Abu Dhabi, Abu Dhabi ↔ Sharjah, and Abu Dhabi ↔ Ajman. Car lift rides and airport transfers. Book by phone or WhatsApp.",
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-2xl leading-relaxed mb-8">
            MJ Car Lift Service operates confirmed inter-emirate car lift and carpool rides.
