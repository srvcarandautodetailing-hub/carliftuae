...
export const metadata: Metadata = {
  title: "Quick Car Lift Service UAE – Car Lift & Airport Transfer UAE",
  description:
    "Quick Car Lift Service UAE covers Dubai ↔ Abu Dhabi, Abu Dhabi ↔ Sharjah, and Abu Dhabi ↔ Ajman. Car lift rides and airport transfers. Book by phone or WhatsApp.",
  alternates: { canonical: "https://www.carliftuae.com/services" },
  openGraph: {
    title: "Quick Car Lift Service UAE – Car Lift & Airport Transfer UAE",
    description:
      "Car lift and airport transfer service on confirmed inter-emirate routes. Dubai ↔ Abu Dhabi from AED 200. Book by phone or WhatsApp.",
    // OG image generated by src/app/services/opengraph-image.tsx
  },
};
...
const comparisonData = [
  {
    question: "I need a car lift between Dubai and Abu Dhabi",
    answer: "Car Lift Service",
    slug: "car-lift-service",
    note: "AED 200 per trip – both directions available",
  },
  {
    question: "I need to travel between Abu Dhabi and Sharjah",
    answer: "Car Lift Service",
    slug: "car-lift-service",
    note: "AED 280 per trip – both directions available",
  },
  {
    question: "I need to travel between Abu Dhabi and Ajman",
    answer: "Car Lift Service",
    slug: "car-lift-service",
    note: "AED 300 per trip – both directions available",
  },
  {
    question: "I need an airport pick-up or drop-off",
    answer: "Airport Transfer Service",
    slug: "airport-transfer",
    note: "All confirmed routes at slightly higher airport fares",
  },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-2xl leading-relaxed mb-8">
            Quick Car Lift Service UAE operates confirmed inter-emirate car lift and carpool rides.
