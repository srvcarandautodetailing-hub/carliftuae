...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    // OG image generated by src/app/about/opengraph-image.tsx
  },
};
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Mission image card */}
            <div className="relative rounded-2xl overflow-hidden min-h-[320px] lg:min-h-[400px] shadow-lg">
              <Image
                src="/images/about/carlift-professional-driver-welcome.webp"
                alt="Professional Car Lift UAE driver welcoming a passenger – verified, background-checked drivers"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
                quality={78}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/85 via-slate-900/20 to-transparent" aria-hidden="true" />
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <blockquote className="text-base font-semibold text-white leading-relaxed mb-4 italic">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white text-sm">Car Lift UAE Founders</p>
                    <p className="text-blue-200 text-xs">Sharjah, 2019</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative w-full h-64 sm:h-80 rounded-2xl overflow-hidden mb-14 shadow-md">
            <Image
              src="/images/about/carlift-uae-fleet-overview-dubai.webp"
              alt="Car Lift UAE fleet overview at Dubai headquarters – Toyota Innova, Mitsubishi Montero, Honda Odyssey vehicles"
              fill
              className="object-cover"
            ...
            <div className="absolute bottom-4 left-6">
              <p className="text-white font-semibold text-sm drop-shadow">Our growing fleet — serving 500+ riders daily across UAE</p>
            </div>
          </div>
