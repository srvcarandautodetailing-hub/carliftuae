...
export const metadata: Metadata = {
  title: "Bus Car Lift Sharjah to Business Bay – AED 130 Sharing / AED 200 Private | +971 54 330 8261",
  description:
    "Shared bus car lift Sharjah to Business Bay from AED 130 sharing / AED 200 private. AC vehicle, GPS-tracked, Salik included, 4.9★ rated. Ladies option. WhatsApp +971 54 330 8261 to book.",
  keywords:
  ...
  openGraph: {
    title: "Bus Car Lift Sharjah to Business Bay – AED 130 Sharing / AED 200 Private | +971 54 330 8261",
    description:
      "Shared AC vehicle, GPS-tracked, Salik included, 4.9★ rated. Departures 6:30 AM – 8:00 AM. Ladies option. WhatsApp +971 54 330 8261.",
    // OG image generated by src/app/bus-car-lift-sharjah-to-business-bay/opengraph-image.tsx
  },
};
...
const PAGE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Monthly bus car lift from Sharjah to Business Bay starts from AED 130 sharing / AED 200 private for pickup from Al Nahda, Sharjah. Areas farther from Dubai (Muweilah, University City) are AED 130 sharing–420/month. Daily trips are AED 100 sharing–35 per one-way trip. All prices include Salik tolls — no hidden charges.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Daily bookings from Sharjah to Business Bay are AED 100 sharing–35 per one-way trip. Book via WhatsApp by 9:00 PM the night before. No monthly contract required.",
  },
  {
...
export default function BusCarLiftSharjahToBusinessBayPage() {
  ...
  const schemas = [
    ...
    serviceSchema({
      ...
      description:
        "Daily shared car lift service from Sharjah to Business Bay, Dubai. Monthly packages from AED 130 sharing / AED 200 private. Salik included.",
    ...
    primaryImageOfPageSchema({
      ...
      pageUrl: "/bus-car-lift-sharjah-to-business-bay",
      caption: "Shared bus car lift pickup in Sharjah – morning departures to Business Bay Dubai, Car Lift UAE",
    }),
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 bg-emerald-500/20 border border-emerald-400/30 rounded-full px-4 py-1.5 text-sm text-emerald-300 font-semibold mb-5">
                ...
                From AED 130 sharing / AED 200 private · Salik Included · Ladies Option Available
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="text-slate-500 text-xs mt-3">
                Daily rate: AED 100 sharing–35/trip. Salik always included. No hidden charges.
              </p>
            </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-700 text-xs leading-relaxed">
                        ...
                        Our monthly car lift from AED 130 sharing saves you over AED 900 every month — AED 10,800/year.
                      </p>
                    </div>
                  </div>
                </CardContent>
